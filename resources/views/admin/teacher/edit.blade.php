                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" value=""
                                                name="address" >{{ old('address', $getRecord->address) }}</textarea>
                                            <div style="color: red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" value=""
                                                name="permanent_address" >{{ old('permanent_address', $getRecord->permanent_address) }}</textarea>
                                            <div style="color: red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" value=""
                                                name="qualification" >{{ old('qualification', $getRecord->qualification) }}</textarea>
                                            <div style="color: red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" value=""
                                                name="work_experience" >{{ old('work_experience', $getRecord->work_experience) }}</textarea>
                                            <div style="color: red;">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" value=""
                                                name="note" >{{ old('note', $getRecord->note) }}</textarea>
                                            <div style="color: red;">
                                                {{ $errors->first('note') }}
                                            </div>
                                        </div>
