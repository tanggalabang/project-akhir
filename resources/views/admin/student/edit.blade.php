                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('caste', $getRecord->caste) }}" name="caste" required
                                                placeholder="Caste">
                                            <div style="color: red;">
                                                {{ $errors->first('caste') }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('height', $getRecord->height) }}" name="height" required
                                                placeholder="Height">
                                            <div style="color: red;">
                                                {{ $errors->first('height') }}
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ old('weight', $getRecord->weight) }}" name="weight" required
                                                placeholder="Weight">
                                            <div style="color: red;">
                                                {{ $errors->first('weight') }}
                                            </div>
